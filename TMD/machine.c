        ...
        *level = root->depth;
        ...
        else
        {
            ...
            if (*branch > 0 && mode == 1)
            {
                ...
                if (jmlSpasi > root3->child->jmlSpace)
                {
                    simpul *bantuan = root3->child;
                ...
                else if (jmlSpasi < root3->child->jmlSpace)
                {
                    root->jmlSpace = root3->child->jmlSpace;
                    //jmlSpasi = root3->child->jmlSpace;
                }
                else
                {
                    root->jmlSpace = jmlSpasi;
